...
python run_recbole.py --model=UCTRL --encoder=MF --dataset=Gowalla --weight_decay=0 --gamma=1 --gpu_id=0 --eval=unbiased
python run_recbole.py --model=UCTRL --encoder=LightGCN --dataset=Gowalla --weight_decay=0 --gamma=1 --n_layers=1 --gpu_id=0 --eval=unbiased

python run_recbole.py --model=UCTRL --encoder=MF --dataset=Yelp --weight_decay=0 --gamma=1 --gpu_id=1 --eval=unbiased
python run_recbole.py --model=UCTRL --encoder=LightGCN --dataset=Yelp --weight_decay=0 --gamma=1 --n_layers=1 --gpu_id=1 --eval=unbiased
...
python run_recbole.py --model=UCTRL --encoder=MF --dataset=Gowalla  --train_batch_size=512 --learning_rate=5e-3 --weight_decay=0 --gamma=1 --gpu_id=0 --eval=unbiased
