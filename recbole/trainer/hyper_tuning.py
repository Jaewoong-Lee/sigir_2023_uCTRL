...
class HyperTuning(object):
    ...
    def _print_result(result_dict: dict):
        ...
        print('current saved model file:')
        print(result_dict['saved_model_file'])
        print()
    ...
    def export_result(self, output_file=None):
        ...
        with open(output_file, 'w') as fp:
            fp.write('Best parameter:\n' + dict2str(self.best_params) + '\n')
            fp.write('Best param. Test result:\n' + dict2str(self.params2result[self.params2str(self.best_params)]['test_result']) + '\n')
            fp.write(', '.join([str(value) for value in self.params2result[self.params2str(self.best_params)]['test_result'].values()]) + '\n')
            fp.write('Best param. Saved model file:\n' + self.params2result[self.params2str(self.best_params)]['saved_model_file'] + '\n\n')
            ...
            for params in self.params2result:
                ...
                fp.write(', '.join([str(value) for value in self.params2result[params]['test_result'].values()]) + '\n')
                fp.write('Saved model file:\n' + self.params2result[params]['saved_model_file'] + '\n\n')
    ...
    def trial(self, params):
        ...
        self.params2result[params_str] = result_dict # dictionary
        ...
        if not self.best_score:
            ...
            # bigger is True, the bigger the better
            if bigger:
